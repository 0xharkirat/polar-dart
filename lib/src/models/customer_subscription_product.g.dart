...
_$CustomerSubscriptionProductImpl _$$CustomerSubscriptionProductImplFromJson(
...
Map<String, dynamic> _$$CustomerSubscriptionProductImplToJson(
        _$CustomerSubscriptionProductImpl instance) =>
    <String, dynamic>{
