...
CustomerProduct _$CustomerProductFromJson(Map<String, dynamic> json) {
  return _CustomerProduct.fromJson(json);
}
...
mixin _$CustomerProduct {
  ...
  $CustomerProductCopyWith<CustomerProduct> get copyWith =>
...
/// @nodoc
abstract class _$$CustomerProductImplCopyWith<$Res>
    implements $CustomerProductCopyWith<$Res> {
  factory _$$CustomerProductImplCopyWith(_$CustomerProductImpl value,
          $Res Function(_$CustomerProductImpl) then) =
      __$$CustomerProductImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$CustomerProductImplCopyWithImpl<$Res>
    extends _$CustomerProductCopyWithImpl<$Res, _$CustomerProductImpl>
    implements _$$CustomerProductImplCopyWith<$Res> {
  __$$CustomerProductImplCopyWithImpl(
      _$CustomerProductImpl _value, $Res Function(_$CustomerProductImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CustomerProductImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CustomerProductImpl implements _CustomerProduct {
  const _$CustomerProductImpl(
      {required this.id,
  ...
  factory _$CustomerProductImpl.fromJson(Map<String, dynamic> json) =>
      _$$CustomerProductImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CustomerProduct(id: $id, created_at: $created_at, modified_at: $modified_at, trial_interval: $trial_interval, trial_interval_count: $trial_interval_count, name: $name, description: $description, visibility: $visibility, recurring_interval: $recurring_interval, recurring_interval_count: $recurring_interval_count, is_recurring: $is_recurring, is_archived: $is_archived, organization_id: $organization_id, prices: $prices, benefits: $benefits, medias: $medias)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CustomerProductImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CustomerProductImplCopyWith<_$CustomerProductImpl> get copyWith =>
      __$$CustomerProductImplCopyWithImpl<_$CustomerProductImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CustomerProductImplToJson(
      this,
    );
  }
}

abstract class _CustomerProduct implements CustomerProduct {
  const factory _CustomerProduct(
          ...
          required final List<BenefitPublic> benefits,
          required final List<ProductMediaFileRead> medias}) =
      _$CustomerProductImpl;

  factory _CustomerProduct.fromJson(Map<String, dynamic> json) =
      _$CustomerProductImpl.fromJson;
