...
_$CustomerBenefitGrantDiscordImpl _$$CustomerBenefitGrantDiscordImplFromJson(
    ...
    _$CustomerBenefitGrantDiscordImpl(
      ...
      benefit: BenefitDiscordSubscriber.fromJson(
          json['benefit'] as Map<String, dynamic>),
      properties: BenefitGrantDiscordProperties.fromJson(
          json['properties'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$CustomerBenefitGrantDiscordImplToJson(
        _$CustomerBenefitGrantDiscordImpl instance) =>
    <String, dynamic>{
