...
_$CheckoutProductsCreateImpl _$$CheckoutProductsCreateImplFromJson(
...
Map<String, dynamic> _$$CheckoutProductsCreateImplToJson(
        _$CheckoutProductsCreateImpl instance) =>
    <String, dynamic>{
