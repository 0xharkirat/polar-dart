...
class _$BenefitDownloadablesSubscriberImpl
  ...
  @override
  String toString() {
    return 'BenefitDownloadablesSubscriber(id: $id, created_at: $created_at, modified_at: $modified_at, type: $type, description: $description, selectable: $selectable, deletable: $deletable, organization_id: $organization_id, metadata: $metadata, organization: $organization, properties: $properties)';
  }
