...
_$CustomerBenefitGrantAdsImpl _$$CustomerBenefitGrantAdsImplFromJson(
    ...
    _$CustomerBenefitGrantAdsImpl(
      ...
      benefit: BenefitAdsSubscriber.fromJson(
          json['benefit'] as Map<String, dynamic>),
      properties: BenefitGrantAdsProperties.fromJson(
          json['properties'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$CustomerBenefitGrantAdsImplToJson(
        _$CustomerBenefitGrantAdsImpl instance) =>
    <String, dynamic>{
