...
part of 'benefit_grant_license_keys_webhook.dart';
...
BenefitGrantLicenseKeysWebhook _$BenefitGrantLicenseKeysWebhookFromJson(
    Map<String, dynamic> json) {
  return _BenefitGrantLicenseKeysWebhook.fromJson(json);
}

/// @nodoc
mixin _$BenefitGrantLicenseKeysWebhook {
  ...
  BenefitLicenseKeys get benefit => throw _privateConstructorUsedError;
  BenefitGrantLicenseKeysProperties get properties =>
      throw _privateConstructorUsedError;
  dynamic? get previous_properties => throw _privateConstructorUsedError;

  /// Serializes this BenefitGrantLicenseKeysWebhook to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BenefitGrantLicenseKeysWebhook
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BenefitGrantLicenseKeysWebhookCopyWith<BenefitGrantLicenseKeysWebhook>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BenefitGrantLicenseKeysWebhookCopyWith<$Res> {
  factory $BenefitGrantLicenseKeysWebhookCopyWith(
          BenefitGrantLicenseKeysWebhook value,
          $Res Function(BenefitGrantLicenseKeysWebhook) then) =
      _$BenefitGrantLicenseKeysWebhookCopyWithImpl<$Res,
  ...
  $Res call(
      ...
      Customer customer,
      dynamic? member,
      BenefitLicenseKeys benefit,
      BenefitGrantLicenseKeysProperties properties,
      dynamic? previous_properties});

  $CustomerCopyWith<$Res> get customer;
  $BenefitLicenseKeysCopyWith<$Res> get benefit;
  $BenefitGrantLicenseKeysPropertiesCopyWith<$Res> get properties;
}

/// @nodoc
class _$BenefitGrantLicenseKeysWebhookCopyWithImpl<$Res,
        $Val extends BenefitGrantLicenseKeysWebhook>
    implements $BenefitGrantLicenseKeysWebhookCopyWith<$Res> {
  _$BenefitGrantLicenseKeysWebhookCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $BenefitLicenseKeysCopyWith<$Res> get benefit {
    return $BenefitLicenseKeysCopyWith<$Res>(_value.benefit, (value) {
...
/// @nodoc
abstract class _$$BenefitGrantLicenseKeysWebhookImplCopyWith<$Res>
    implements $BenefitGrantLicenseKeysWebhookCopyWith<$Res> {
  factory _$$BenefitGrantLicenseKeysWebhookImplCopyWith(
          _$BenefitGrantLicenseKeysWebhookImpl value,
          $Res Function(_$BenefitGrantLicenseKeysWebhookImpl) then) =
      __$$BenefitGrantLicenseKeysWebhookImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$BenefitGrantLicenseKeysWebhookImplCopyWithImpl<$Res>
    extends _$BenefitGrantLicenseKeysWebhookCopyWithImpl<$Res,
        _$BenefitGrantLicenseKeysWebhookImpl>
    implements _$$BenefitGrantLicenseKeysWebhookImplCopyWith<$Res> {
  __$$BenefitGrantLicenseKeysWebhookImplCopyWithImpl(
      _$BenefitGrantLicenseKeysWebhookImpl _value,
      $Res Function(_$BenefitGrantLicenseKeysWebhookImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BenefitGrantLicenseKeysWebhookImpl(
      created_at: null == created_at
          ? _value.created_at
          : created_at // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$BenefitGrantLicenseKeysWebhookImpl
    implements _BenefitGrantLicenseKeysWebhook {
  const _$BenefitGrantLicenseKeysWebhookImpl(
  ...
  factory _$BenefitGrantLicenseKeysWebhookImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$BenefitGrantLicenseKeysWebhookImplFromJson(json);
  ...
  @override
  final BenefitLicenseKeys benefit;
  @override
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BenefitGrantLicenseKeysWebhookImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BenefitGrantLicenseKeysWebhookImplCopyWith<
          _$BenefitGrantLicenseKeysWebhookImpl>
      get copyWith => __$$BenefitGrantLicenseKeysWebhookImplCopyWithImpl<
          _$BenefitGrantLicenseKeysWebhookImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BenefitGrantLicenseKeysWebhookImplToJson(
      this,
    );
  }
}

abstract class _BenefitGrantLicenseKeysWebhook
    implements BenefitGrantLicenseKeysWebhook {
  const factory _BenefitGrantLicenseKeysWebhook(
          ...
          final dynamic? member,
          required final BenefitLicenseKeys benefit,
          required final BenefitGrantLicenseKeysProperties properties,
          final dynamic? previous_properties}) =
      _$BenefitGrantLicenseKeysWebhookImpl;

  factory _BenefitGrantLicenseKeysWebhook.fromJson(Map<String, dynamic> json) =
      _$BenefitGrantLicenseKeysWebhookImpl.fromJson;
  ...
  dynamic? get member;
  @override
  BenefitLicenseKeys get benefit;
  @override
  BenefitGrantLicenseKeysProperties get properties;
  @override
