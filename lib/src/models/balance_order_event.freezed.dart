...
part of 'balance_order_event.dart';
...
BalanceOrderEvent _$BalanceOrderEventFromJson(Map<String, dynamic> json) {
  return _BalanceOrderEvent.fromJson(json);
}

/// @nodoc
mixin _$BalanceOrderEvent {
  ...
  BalanceOrderMetadata get metadata => throw _privateConstructorUsedError;

  /// Serializes this BalanceOrderEvent to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BalanceOrderEvent
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BalanceOrderEventCopyWith<BalanceOrderEvent> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BalanceOrderEventCopyWith<$Res> {
  factory $BalanceOrderEventCopyWith(
          BalanceOrderEvent value, $Res Function(BalanceOrderEvent) then) =
      _$BalanceOrderEventCopyWithImpl<$Res, BalanceOrderEvent>;
  @useResult
  $Res call(
      {String id,
      String timestamp,
      ...
      String source,
      String name,
      BalanceOrderMetadata metadata});

  $BalanceOrderMetadataCopyWith<$Res> get metadata;
}

/// @nodoc
class _$BalanceOrderEventCopyWithImpl<$Res, $Val extends BalanceOrderEvent>
    implements $BalanceOrderEventCopyWith<$Res> {
  _$BalanceOrderEventCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $BalanceOrderMetadataCopyWith<$Res> get metadata {
    return $BalanceOrderMetadataCopyWith<$Res>(_value.metadata, (value) {
...
/// @nodoc
abstract class _$$BalanceOrderEventImplCopyWith<$Res>
    implements $BalanceOrderEventCopyWith<$Res> {
  factory _$$BalanceOrderEventImplCopyWith(_$BalanceOrderEventImpl value,
          $Res Function(_$BalanceOrderEventImpl) then) =
      __$$BalanceOrderEventImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$BalanceOrderEventImplCopyWithImpl<$Res>
    extends _$BalanceOrderEventCopyWithImpl<$Res, _$BalanceOrderEventImpl>
    implements _$$BalanceOrderEventImplCopyWith<$Res> {
  __$$BalanceOrderEventImplCopyWithImpl(_$BalanceOrderEventImpl _value,
      $Res Function(_$BalanceOrderEventImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BalanceOrderEventImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$BalanceOrderEventImpl implements _BalanceOrderEvent {
  const _$BalanceOrderEventImpl(
      {required this.id,
  ...
  factory _$BalanceOrderEventImpl.fromJson(Map<String, dynamic> json) =>
      _$$BalanceOrderEventImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BalanceOrderEventImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BalanceOrderEventImplCopyWith<_$BalanceOrderEventImpl> get copyWith =>
      __$$BalanceOrderEventImplCopyWithImpl<_$BalanceOrderEventImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BalanceOrderEventImplToJson(
      this,
    );
  }
}

abstract class _BalanceOrderEvent implements BalanceOrderEvent {
  const factory _BalanceOrderEvent(
      ...
      required final BalanceOrderMetadata metadata}) = _$BalanceOrderEventImpl;

  factory _BalanceOrderEvent.fromJson(Map<String, dynamic> json) =
      _$BalanceOrderEventImpl.fromJson;
  ...
  String get name;
  @override
  BalanceOrderMetadata get metadata;
