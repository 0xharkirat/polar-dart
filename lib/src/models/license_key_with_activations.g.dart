...
_$LicenseKeyWithActivationsImpl _$$LicenseKeyWithActivationsImplFromJson(
    ...
    _$LicenseKeyWithActivationsImpl(
      ...
      activations: (json['activations'] as List<dynamic>)
          .map((e) =>
              LicenseKeyActivationBase.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$LicenseKeyWithActivationsImplToJson(
        _$LicenseKeyWithActivationsImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
