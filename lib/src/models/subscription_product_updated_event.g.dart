...
_$SubscriptionProductUpdatedEventImpl
    _$$SubscriptionProductUpdatedEventImplFromJson(Map<String, dynamic> json) =>
        _$SubscriptionProductUpdatedEventImpl(
          ...
          metadata: SubscriptionProductUpdatedMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$$SubscriptionProductUpdatedEventImplToJson(
        _$SubscriptionProductUpdatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
