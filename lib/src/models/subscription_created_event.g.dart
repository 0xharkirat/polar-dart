...
_$SubscriptionCreatedEventImpl _$$SubscriptionCreatedEventImplFromJson(
    ...
    _$SubscriptionCreatedEventImpl(
      ...
      metadata: SubscriptionCreatedMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$SubscriptionCreatedEventImplToJson(
        _$SubscriptionCreatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
