...
_$CustomerBenefitGrantFeatureFlagImpl
    _$$CustomerBenefitGrantFeatureFlagImplFromJson(Map<String, dynamic> json) =>
        _$CustomerBenefitGrantFeatureFlagImpl(
          ...
          benefit: BenefitFeatureFlagSubscriber.fromJson(
              json['benefit'] as Map<String, dynamic>),
          properties: json['properties'] as Map<String, dynamic>,
        );

Map<String, dynamic> _$$CustomerBenefitGrantFeatureFlagImplToJson(
        _$CustomerBenefitGrantFeatureFlagImpl instance) =>
    <String, dynamic>{
