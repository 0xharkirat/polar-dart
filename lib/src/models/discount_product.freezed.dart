...
class _$DiscountProductImpl implements _DiscountProduct {
  ...
  @override
  String toString() {
    return 'DiscountProduct(metadata: $metadata, id: $id, created_at: $created_at, modified_at: $modified_at, trial_interval: $trial_interval, trial_interval_count: $trial_interval_count, name: $name, description: $description, visibility: $visibility, recurring_interval: $recurring_interval, recurring_interval_count: $recurring_interval_count, is_recurring: $is_recurring, is_archived: $is_archived, organization_id: $organization_id)';
  }
