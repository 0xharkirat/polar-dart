...
class _$AddressInputImpl implements _AddressInput {
  ...
  @override
  String toString() {
    return 'AddressInput(line1: $line1, line2: $line2, postal_code: $postal_code, city: $city, state: $state, country: $country)';
  }
...
abstract class _AddressInput implements AddressInput {
  const factory _AddressInput(
      ...
      final String? city,
      final String? state,
      required final String country}) = _$AddressInputImpl;
