...
ValidatedLicenseKey _$ValidatedLicenseKeyFromJson(Map<String, dynamic> json) {
  return _ValidatedLicenseKey.fromJson(json);
}
...
mixin _$ValidatedLicenseKey {
  ...
  dynamic? get activation => throw _privateConstructorUsedError;

  /// Serializes this ValidatedLicenseKey to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ValidatedLicenseKey
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ValidatedLicenseKeyCopyWith<ValidatedLicenseKey> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ValidatedLicenseKeyCopyWith<$Res> {
  factory $ValidatedLicenseKeyCopyWith(
          ValidatedLicenseKey value, $Res Function(ValidatedLicenseKey) then) =
      _$ValidatedLicenseKeyCopyWithImpl<$Res, ValidatedLicenseKey>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$ValidatedLicenseKeyCopyWithImpl<$Res, $Val extends ValidatedLicenseKey>
    implements $ValidatedLicenseKeyCopyWith<$Res> {
  _$ValidatedLicenseKeyCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ValidatedLicenseKeyImplCopyWith<$Res>
    implements $ValidatedLicenseKeyCopyWith<$Res> {
  factory _$$ValidatedLicenseKeyImplCopyWith(_$ValidatedLicenseKeyImpl value,
          $Res Function(_$ValidatedLicenseKeyImpl) then) =
      __$$ValidatedLicenseKeyImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$ValidatedLicenseKeyImplCopyWithImpl<$Res>
    extends _$ValidatedLicenseKeyCopyWithImpl<$Res, _$ValidatedLicenseKeyImpl>
    implements _$$ValidatedLicenseKeyImplCopyWith<$Res> {
  __$$ValidatedLicenseKeyImplCopyWithImpl(_$ValidatedLicenseKeyImpl _value,
      $Res Function(_$ValidatedLicenseKeyImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ValidatedLicenseKeyImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$ValidatedLicenseKeyImpl implements _ValidatedLicenseKey {
  ...
  factory _$ValidatedLicenseKeyImpl.fromJson(Map<String, dynamic> json) =>
      _$$ValidatedLicenseKeyImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.activation, activation));
  }
  ...
  int get hashCode => Object.hash(
      ...
      last_validated_at,
      expires_at,
      const DeepCollectionEquality().hash(activation));
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ValidatedLicenseKeyImplCopyWith<_$ValidatedLicenseKeyImpl> get copyWith =>
      __$$ValidatedLicenseKeyImplCopyWithImpl<_$ValidatedLicenseKeyImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ValidatedLicenseKeyImplToJson(
      this,
    );
  }
}
...
abstract class _ValidatedLicenseKey implements ValidatedLicenseKey {
  const factory _ValidatedLicenseKey(
      ...
      final dynamic? activation}) = _$ValidatedLicenseKeyImpl;

  factory _ValidatedLicenseKey.fromJson(Map<String, dynamic> json) =
      _$ValidatedLicenseKeyImpl.fromJson;
