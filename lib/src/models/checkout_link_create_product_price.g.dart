...
_$CheckoutLinkCreateProductPriceImpl
    _$$CheckoutLinkCreateProductPriceImplFromJson(Map<String, dynamic> json) =>
        _$CheckoutLinkCreateProductPriceImpl(
...
Map<String, dynamic> _$$CheckoutLinkCreateProductPriceImplToJson(
        _$CheckoutLinkCreateProductPriceImpl instance) =>
    <String, dynamic>{
