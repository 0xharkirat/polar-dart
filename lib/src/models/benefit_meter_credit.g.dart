...
_$BenefitMeterCreditImpl _$$BenefitMeterCreditImplFromJson(
    ...
    _$BenefitMeterCreditImpl(
      ...
      properties: BenefitMeterCreditProperties.fromJson(
          json['properties'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$BenefitMeterCreditImplToJson(
        _$BenefitMeterCreditImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
