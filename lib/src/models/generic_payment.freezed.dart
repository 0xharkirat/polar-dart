...
GenericPayment _$GenericPaymentFromJson(Map<String, dynamic> json) {
  return _GenericPayment.fromJson(json);
}

/// @nodoc
mixin _$GenericPayment {
  ...
  /// Serializes this GenericPayment to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GenericPayment
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GenericPaymentCopyWith<GenericPayment> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GenericPaymentCopyWith<$Res> {
  factory $GenericPaymentCopyWith(
          GenericPayment value, $Res Function(GenericPayment) then) =
      _$GenericPaymentCopyWithImpl<$Res, GenericPayment>;
  @useResult
  $Res call(
      {String created_at,
      String? modified_at,
...
/// @nodoc
class _$GenericPaymentCopyWithImpl<$Res, $Val extends GenericPayment>
    implements $GenericPaymentCopyWith<$Res> {
  _$GenericPaymentCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GenericPaymentImplCopyWith<$Res>
    implements $GenericPaymentCopyWith<$Res> {
  factory _$$GenericPaymentImplCopyWith(_$GenericPaymentImpl value,
          $Res Function(_$GenericPaymentImpl) then) =
      __$$GenericPaymentImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$GenericPaymentImplCopyWithImpl<$Res>
    extends _$GenericPaymentCopyWithImpl<$Res, _$GenericPaymentImpl>
    implements _$$GenericPaymentImplCopyWith<$Res> {
  __$$GenericPaymentImplCopyWithImpl(
      _$GenericPaymentImpl _value, $Res Function(_$GenericPaymentImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GenericPaymentImpl(
      created_at: null == created_at
          ? _value.created_at
          : created_at // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GenericPaymentImpl implements _GenericPayment {
  const _$GenericPaymentImpl(
  ...
  factory _$GenericPaymentImpl.fromJson(Map<String, dynamic> json) =>
      _$$GenericPaymentImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GenericPaymentImplCopyWith<_$GenericPaymentImpl> get copyWith =>
      __$$GenericPaymentImplCopyWithImpl<_$GenericPaymentImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GenericPaymentImplToJson(
      this,
    );
  }
}

abstract class _GenericPayment implements GenericPayment {
  const factory _GenericPayment(
      ...
      final Map<String, dynamic>? processor_metadata}) = _$GenericPaymentImpl;

  factory _GenericPayment.fromJson(Map<String, dynamic> json) =
      _$GenericPaymentImpl.fromJson;
