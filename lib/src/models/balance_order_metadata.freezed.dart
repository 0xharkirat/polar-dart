...
BalanceOrderMetadata _$BalanceOrderMetadataFromJson(Map<String, dynamic> json) {
  return _BalanceOrderMetadata.fromJson(json);
}

/// @nodoc
mixin _$BalanceOrderMetadata {
  ...
  /// Serializes this BalanceOrderMetadata to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BalanceOrderMetadata
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BalanceOrderMetadataCopyWith<BalanceOrderMetadata> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BalanceOrderMetadataCopyWith<$Res> {
  factory $BalanceOrderMetadataCopyWith(BalanceOrderMetadata value,
          $Res Function(BalanceOrderMetadata) then) =
      _$BalanceOrderMetadataCopyWithImpl<$Res, BalanceOrderMetadata>;
  @useResult
  $Res call(
...
/// @nodoc
class _$BalanceOrderMetadataCopyWithImpl<$Res,
        $Val extends BalanceOrderMetadata>
    implements $BalanceOrderMetadataCopyWith<$Res> {
  _$BalanceOrderMetadataCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BalanceOrderMetadataImplCopyWith<$Res>
    implements $BalanceOrderMetadataCopyWith<$Res> {
  factory _$$BalanceOrderMetadataImplCopyWith(_$BalanceOrderMetadataImpl value,
          $Res Function(_$BalanceOrderMetadataImpl) then) =
      __$$BalanceOrderMetadataImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String transaction_id,
...
/// @nodoc
class __$$BalanceOrderMetadataImplCopyWithImpl<$Res>
    extends _$BalanceOrderMetadataCopyWithImpl<$Res, _$BalanceOrderMetadataImpl>
    implements _$$BalanceOrderMetadataImplCopyWith<$Res> {
  __$$BalanceOrderMetadataImplCopyWithImpl(_$BalanceOrderMetadataImpl _value,
      $Res Function(_$BalanceOrderMetadataImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BalanceOrderMetadataImpl(
      transaction_id: null == transaction_id
          ? _value.transaction_id
          : transaction_id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$BalanceOrderMetadataImpl implements _BalanceOrderMetadata {
  const _$BalanceOrderMetadataImpl(
  ...
  factory _$BalanceOrderMetadataImpl.fromJson(Map<String, dynamic> json) =>
      _$$BalanceOrderMetadataImplFromJson(json);
  ...
  @override
  String toString() {
    return 'BalanceOrderMetadata(transaction_id: $transaction_id, order_id: $order_id, product_id: $product_id, subscription_id: $subscription_id, amount: $amount, net_amount: $net_amount, currency: $currency, presentment_amount: $presentment_amount, presentment_currency: $presentment_currency, tax_amount: $tax_amount, tax_state: $tax_state, tax_country: $tax_country, fee: $fee, exchange_rate: $exchange_rate)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BalanceOrderMetadataImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BalanceOrderMetadataImplCopyWith<_$BalanceOrderMetadataImpl>
      get copyWith =>
          __$$BalanceOrderMetadataImplCopyWithImpl<_$BalanceOrderMetadataImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BalanceOrderMetadataImplToJson(
      this,
    );
  }
}

abstract class _BalanceOrderMetadata implements BalanceOrderMetadata {
  const factory _BalanceOrderMetadata(
      ...
      final double? exchange_rate}) = _$BalanceOrderMetadataImpl;

  factory _BalanceOrderMetadata.fromJson(Map<String, dynamic> json) =
      _$BalanceOrderMetadataImpl.fromJson;
