...
_$ProductMediaFileReadImpl _$$ProductMediaFileReadImplFromJson(
        Map<String, dynamic> json) =>
    _$ProductMediaFileReadImpl(
...
Map<String, dynamic> _$$ProductMediaFileReadImplToJson(
        _$ProductMediaFileReadImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
