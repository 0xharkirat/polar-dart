...
BenefitLicenseKeys _$BenefitLicenseKeysFromJson(Map<String, dynamic> json) {
  return _BenefitLicenseKeys.fromJson(json);
}
...
mixin _$BenefitLicenseKeys {
  ...
  /// Serializes this BenefitLicenseKeys to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BenefitLicenseKeys
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BenefitLicenseKeysCopyWith<BenefitLicenseKeys> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BenefitLicenseKeysCopyWith<$Res> {
  factory $BenefitLicenseKeysCopyWith(
          BenefitLicenseKeys value, $Res Function(BenefitLicenseKeys) then) =
...
/// @nodoc
class _$BenefitLicenseKeysCopyWithImpl<$Res, $Val extends BenefitLicenseKeys>
    implements $BenefitLicenseKeysCopyWith<$Res> {
  _$BenefitLicenseKeysCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $BenefitLicenseKeysPropertiesCopyWith<$Res> get properties {
    return $BenefitLicenseKeysPropertiesCopyWith<$Res>(_value.properties,
        (value) {
...
/// @nodoc
abstract class _$$BenefitLicenseKeysImplCopyWith<$Res>
    implements $BenefitLicenseKeysCopyWith<$Res> {
  factory _$$BenefitLicenseKeysImplCopyWith(_$BenefitLicenseKeysImpl value,
          $Res Function(_$BenefitLicenseKeysImpl) then) =
      __$$BenefitLicenseKeysImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$BenefitLicenseKeysImplCopyWithImpl<$Res>
    extends _$BenefitLicenseKeysCopyWithImpl<$Res, _$BenefitLicenseKeysImpl>
    implements _$$BenefitLicenseKeysImplCopyWith<$Res> {
  __$$BenefitLicenseKeysImplCopyWithImpl(_$BenefitLicenseKeysImpl _value,
      $Res Function(_$BenefitLicenseKeysImpl) _then)
      : super(_value, _then);
...
class _$BenefitLicenseKeysImpl implements _BenefitLicenseKeys {
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BenefitLicenseKeysImplCopyWith<_$BenefitLicenseKeysImpl> get copyWith =>
      __$$BenefitLicenseKeysImplCopyWithImpl<_$BenefitLicenseKeysImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BenefitLicenseKeysImplToJson(
      this,
    );
  }
}
...
abstract class _BenefitLicenseKeys implements BenefitLicenseKeys {
  ...
  factory _BenefitLicenseKeys.fromJson(Map<String, dynamic> json) =
