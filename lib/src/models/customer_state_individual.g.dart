...
_$CustomerStateIndividualImpl _$$CustomerStateIndividualImplFromJson(
...
Map<String, dynamic> _$$CustomerStateIndividualImplToJson(
        _$CustomerStateIndividualImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
