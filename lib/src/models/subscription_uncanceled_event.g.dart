...
_$SubscriptionUncanceledEventImpl _$$SubscriptionUncanceledEventImplFromJson(
    ...
    _$SubscriptionUncanceledEventImpl(
      ...
      metadata: SubscriptionUncanceledMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$SubscriptionUncanceledEventImplToJson(
        _$SubscriptionUncanceledEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
