...
_$CustomerCustomerMeterImpl _$$CustomerCustomerMeterImplFromJson(
    ...
    _$CustomerCustomerMeterImpl(
      ...
      meter: CustomerCustomerMeterMeter.fromJson(
          json['meter'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$CustomerCustomerMeterImplToJson(
        _$CustomerCustomerMeterImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
