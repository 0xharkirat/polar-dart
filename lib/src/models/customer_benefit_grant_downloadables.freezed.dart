...
CustomerBenefitGrantDownloadables _$CustomerBenefitGrantDownloadablesFromJson(
    Map<String, dynamic> json) {
  return _CustomerBenefitGrantDownloadables.fromJson(json);
}

/// @nodoc
mixin _$CustomerBenefitGrantDownloadables {
  ...
  BenefitDownloadablesSubscriber get benefit =>
      throw _privateConstructorUsedError;
  BenefitGrantDownloadablesProperties get properties =>
      throw _privateConstructorUsedError;

  /// Serializes this CustomerBenefitGrantDownloadables to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CustomerBenefitGrantDownloadables
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CustomerBenefitGrantDownloadablesCopyWith<CustomerBenefitGrantDownloadables>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CustomerBenefitGrantDownloadablesCopyWith<$Res> {
  factory $CustomerBenefitGrantDownloadablesCopyWith(
          CustomerBenefitGrantDownloadables value,
          $Res Function(CustomerBenefitGrantDownloadables) then) =
      _$CustomerBenefitGrantDownloadablesCopyWithImpl<$Res,
  ...
  $Res call(
      ...
      BenefitDownloadablesSubscriber benefit,
      BenefitGrantDownloadablesProperties properties});

  $CustomerPortalCustomerCopyWith<$Res> get customer;
  $BenefitDownloadablesSubscriberCopyWith<$Res> get benefit;
  $BenefitGrantDownloadablesPropertiesCopyWith<$Res> get properties;
}

/// @nodoc
class _$CustomerBenefitGrantDownloadablesCopyWithImpl<$Res,
        $Val extends CustomerBenefitGrantDownloadables>
    implements $CustomerBenefitGrantDownloadablesCopyWith<$Res> {
  _$CustomerBenefitGrantDownloadablesCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      benefit: null == benefit
          ...
          : benefit // ignore: cast_nullable_to_non_nullable
              as BenefitDownloadablesSubscriber,
  ...
  @pragma('vm:prefer-inline')
  $BenefitDownloadablesSubscriberCopyWith<$Res> get benefit {
    return $BenefitDownloadablesSubscriberCopyWith<$Res>(_value.benefit,
        (value) {
...
/// @nodoc
abstract class _$$CustomerBenefitGrantDownloadablesImplCopyWith<$Res>
    implements $CustomerBenefitGrantDownloadablesCopyWith<$Res> {
  factory _$$CustomerBenefitGrantDownloadablesImplCopyWith(
          _$CustomerBenefitGrantDownloadablesImpl value,
          $Res Function(_$CustomerBenefitGrantDownloadablesImpl) then) =
      __$$CustomerBenefitGrantDownloadablesImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$CustomerBenefitGrantDownloadablesImplCopyWithImpl<$Res>
    extends _$CustomerBenefitGrantDownloadablesCopyWithImpl<$Res,
        _$CustomerBenefitGrantDownloadablesImpl>
    implements _$$CustomerBenefitGrantDownloadablesImplCopyWith<$Res> {
  __$$CustomerBenefitGrantDownloadablesImplCopyWithImpl(
      _$CustomerBenefitGrantDownloadablesImpl _value,
      $Res Function(_$CustomerBenefitGrantDownloadablesImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CustomerBenefitGrantDownloadablesImpl(
      created_at: null == created_at
          ? _value.created_at
          : created_at // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CustomerBenefitGrantDownloadablesImpl
    implements _CustomerBenefitGrantDownloadables {
  const _$CustomerBenefitGrantDownloadablesImpl(
  ...
  factory _$CustomerBenefitGrantDownloadablesImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CustomerBenefitGrantDownloadablesImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CustomerBenefitGrantDownloadablesImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CustomerBenefitGrantDownloadablesImplCopyWith<
          _$CustomerBenefitGrantDownloadablesImpl>
      get copyWith => __$$CustomerBenefitGrantDownloadablesImplCopyWithImpl<
          _$CustomerBenefitGrantDownloadablesImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CustomerBenefitGrantDownloadablesImplToJson(
      this,
    );
  }
}

abstract class _CustomerBenefitGrantDownloadables
    implements CustomerBenefitGrantDownloadables {
  const factory _CustomerBenefitGrantDownloadables(
          ...
          required final BenefitDownloadablesSubscriber benefit,
          required final BenefitGrantDownloadablesProperties properties}) =
      _$CustomerBenefitGrantDownloadablesImpl;

  factory _CustomerBenefitGrantDownloadables.fromJson(
          Map<String, dynamic> json) =
      _$CustomerBenefitGrantDownloadablesImpl.fromJson;
