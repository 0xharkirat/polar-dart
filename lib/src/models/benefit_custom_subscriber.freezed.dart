...
BenefitCustomSubscriber _$BenefitCustomSubscriberFromJson(
    Map<String, dynamic> json) {
  return _BenefitCustomSubscriber.fromJson(json);
}
...
mixin _$BenefitCustomSubscriber {
  ...
  /// Serializes this BenefitCustomSubscriber to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BenefitCustomSubscriber
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BenefitCustomSubscriberCopyWith<BenefitCustomSubscriber> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BenefitCustomSubscriberCopyWith<$Res> {
  factory $BenefitCustomSubscriberCopyWith(BenefitCustomSubscriber value,
          $Res Function(BenefitCustomSubscriber) then) =
...
/// @nodoc
class _$BenefitCustomSubscriberCopyWithImpl<$Res,
        $Val extends BenefitCustomSubscriber>
    implements $BenefitCustomSubscriberCopyWith<$Res> {
  _$BenefitCustomSubscriberCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      properties: null == properties
          ...
          : properties // ignore: cast_nullable_to_non_nullable
              as BenefitCustomSubscriberProperties,
    ) as $Val);
  }
  ...
  @pragma('vm:prefer-inline')
  $BenefitCustomSubscriberPropertiesCopyWith<$Res> get properties {
    return $BenefitCustomSubscriberPropertiesCopyWith<$Res>(_value.properties,
        (value) {
...
/// @nodoc
abstract class _$$BenefitCustomSubscriberImplCopyWith<$Res>
    implements $BenefitCustomSubscriberCopyWith<$Res> {
  factory _$$BenefitCustomSubscriberImplCopyWith(
          _$BenefitCustomSubscriberImpl value,
          $Res Function(_$BenefitCustomSubscriberImpl) then) =
      __$$BenefitCustomSubscriberImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$BenefitCustomSubscriberImplCopyWithImpl<$Res>
    extends _$BenefitCustomSubscriberCopyWithImpl<$Res,
        _$BenefitCustomSubscriberImpl>
    implements _$$BenefitCustomSubscriberImplCopyWith<$Res> {
  __$$BenefitCustomSubscriberImplCopyWithImpl(
      _$BenefitCustomSubscriberImpl _value,
      $Res Function(_$BenefitCustomSubscriberImpl) _then)
      : super(_value, _then);
...
class _$BenefitCustomSubscriberImpl implements _BenefitCustomSubscriber {
  ...
  factory _$BenefitCustomSubscriberImpl.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BenefitCustomSubscriberImplCopyWith<_$BenefitCustomSubscriberImpl>
      get copyWith => __$$BenefitCustomSubscriberImplCopyWithImpl<
          _$BenefitCustomSubscriberImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BenefitCustomSubscriberImplToJson(
      this,
    );
  }
}
...
abstract class _BenefitCustomSubscriber implements BenefitCustomSubscriber {
  ...
  factory _BenefitCustomSubscriber.fromJson(Map<String, dynamic> json) =
