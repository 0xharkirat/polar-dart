...
_$SubscriptionBillingPeriodUpdatedEventImpl
    _$$SubscriptionBillingPeriodUpdatedEventImplFromJson(
        ...
        _$SubscriptionBillingPeriodUpdatedEventImpl(
          ...
          metadata: SubscriptionBillingPeriodUpdatedMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$$SubscriptionBillingPeriodUpdatedEventImplToJson(
        _$SubscriptionBillingPeriodUpdatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
