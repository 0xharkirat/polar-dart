...
_$CustomerBenefitGrantLicenseKeysImpl
    _$$CustomerBenefitGrantLicenseKeysImplFromJson(Map<String, dynamic> json) =>
        _$CustomerBenefitGrantLicenseKeysImpl(
          ...
          benefit: BenefitLicenseKeysSubscriber.fromJson(
              json['benefit'] as Map<String, dynamic>),
          properties: BenefitGrantLicenseKeysProperties.fromJson(
              json['properties'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$$CustomerBenefitGrantLicenseKeysImplToJson(
        _$CustomerBenefitGrantLicenseKeysImpl instance) =>
    <String, dynamic>{
