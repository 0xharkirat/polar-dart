...
_$ProductPriceSeatBasedImpl _$$ProductPriceSeatBasedImplFromJson(
    ...
    _$ProductPriceSeatBasedImpl(
      ...
      seat_tiers: ProductPriceSeatTiersOutput.fromJson(
          json['seat_tiers'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$ProductPriceSeatBasedImplToJson(
        _$ProductPriceSeatBasedImpl instance) =>
    <String, dynamic>{
