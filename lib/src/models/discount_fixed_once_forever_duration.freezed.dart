...
class _$DiscountFixedOnceForeverDurationImpl
  ...
  @override
  String toString() {
    return 'DiscountFixedOnceForeverDuration(duration: $duration, type: $type, amount: $amount, currency: $currency, amounts: $amounts, created_at: $created_at, modified_at: $modified_at, id: $id, metadata: $metadata, name: $name, code: $code, starts_at: $starts_at, ends_at: $ends_at, max_redemptions: $max_redemptions, redemptions_count: $redemptions_count, organization_id: $organization_id, products: $products)';
  }
