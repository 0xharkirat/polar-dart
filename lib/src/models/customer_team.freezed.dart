...
CustomerTeam _$CustomerTeamFromJson(Map<String, dynamic> json) {
  return _CustomerTeam.fromJson(json);
}

/// @nodoc
mixin _$CustomerTeam {
  ...
  /// Serializes this CustomerTeam to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CustomerTeam
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CustomerTeamCopyWith<CustomerTeam> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CustomerTeamCopyWith<$Res> {
  factory $CustomerTeamCopyWith(
          CustomerTeam value, $Res Function(CustomerTeam) then) =
      _$CustomerTeamCopyWithImpl<$Res, CustomerTeam>;
  @useResult
  $Res call(
      {String id,
      String created_at,
...
/// @nodoc
class _$CustomerTeamCopyWithImpl<$Res, $Val extends CustomerTeam>
    implements $CustomerTeamCopyWith<$Res> {
  _$CustomerTeamCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CustomerTeamImplCopyWith<$Res>
    implements $CustomerTeamCopyWith<$Res> {
  factory _$$CustomerTeamImplCopyWith(
          _$CustomerTeamImpl value, $Res Function(_$CustomerTeamImpl) then) =
      __$$CustomerTeamImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$CustomerTeamImplCopyWithImpl<$Res>
    extends _$CustomerTeamCopyWithImpl<$Res, _$CustomerTeamImpl>
    implements _$$CustomerTeamImplCopyWith<$Res> {
  __$$CustomerTeamImplCopyWithImpl(
      _$CustomerTeamImpl _value, $Res Function(_$CustomerTeamImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CustomerTeamImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CustomerTeamImpl implements _CustomerTeam {
  const _$CustomerTeamImpl(
      {required this.id,
  ...
  factory _$CustomerTeamImpl.fromJson(Map<String, dynamic> json) =>
      _$$CustomerTeamImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CustomerTeam(id: $id, created_at: $created_at, modified_at: $modified_at, metadata: $metadata, external_id: $external_id, email: $email, email_verified: $email_verified, type: $type, name: $name, billing_address: $billing_address, tax_id: $tax_id, locale: $locale, organization_id: $organization_id, deleted_at: $deleted_at, avatar_url: $avatar_url)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CustomerTeamImplCopyWith<_$CustomerTeamImpl> get copyWith =>
      __$$CustomerTeamImplCopyWithImpl<_$CustomerTeamImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CustomerTeamImplToJson(
      this,
    );
  }
}

abstract class _CustomerTeam implements CustomerTeam {
  const factory _CustomerTeam(
      ...
      required final String avatar_url}) = _$CustomerTeamImpl;

  factory _CustomerTeam.fromJson(Map<String, dynamic> json) =
      _$CustomerTeamImpl.fromJson;
