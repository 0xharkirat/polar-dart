...
_$BenefitGrantFeatureFlagWebhookImpl
    _$$BenefitGrantFeatureFlagWebhookImplFromJson(Map<String, dynamic> json) =>
        _$BenefitGrantFeatureFlagWebhookImpl(
          ...
          member: json['member'],
          benefit: BenefitFeatureFlag.fromJson(
              json['benefit'] as Map<String, dynamic>),
          properties: json['properties'] as Map<String, dynamic>,
          previous_properties: json['previous_properties'],
        );

Map<String, dynamic> _$$BenefitGrantFeatureFlagWebhookImplToJson(
        _$BenefitGrantFeatureFlagWebhookImpl instance) =>
    <String, dynamic>{
