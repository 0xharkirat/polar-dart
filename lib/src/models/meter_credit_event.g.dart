...
_$MeterCreditEventImpl _$$MeterCreditEventImplFromJson(
        Map<String, dynamic> json) =>
    _$MeterCreditEventImpl(
      ...
      metadata: MeterCreditedMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$MeterCreditEventImplToJson(
        _$MeterCreditEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
