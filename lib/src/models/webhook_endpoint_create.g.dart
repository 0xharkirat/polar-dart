...
_$WebhookEndpointCreateImpl _$$WebhookEndpointCreateImplFromJson(
...
Map<String, dynamic> _$$WebhookEndpointCreateImplToJson(
        _$WebhookEndpointCreateImpl instance) =>
    <String, dynamic>{
      'url': instance.url,
