...
_$DiscountFixedRepeatDurationBaseImpl
    _$$DiscountFixedRepeatDurationBaseImplFromJson(Map<String, dynamic> json) =>
        _$DiscountFixedRepeatDurationBaseImpl(
...
Map<String, dynamic> _$$DiscountFixedRepeatDurationBaseImplToJson(
        _$DiscountFixedRepeatDurationBaseImpl instance) =>
    <String, dynamic>{
