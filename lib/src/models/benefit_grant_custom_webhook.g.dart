...
_$BenefitGrantCustomWebhookImpl _$$BenefitGrantCustomWebhookImplFromJson(
    ...
    _$BenefitGrantCustomWebhookImpl(
      ...
      member: json['member'],
      benefit: BenefitCustom.fromJson(json['benefit'] as Map<String, dynamic>),
      properties: json['properties'] as Map<String, dynamic>,
      previous_properties: json['previous_properties'],
    );

Map<String, dynamic> _$$BenefitGrantCustomWebhookImplToJson(
        _$BenefitGrantCustomWebhookImpl instance) =>
    <String, dynamic>{
