...
part of 'benefit_grant_git_hub_repository_webhook.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$BenefitGrantGitHubRepositoryWebhookImpl
    _$$BenefitGrantGitHubRepositoryWebhookImplFromJson(
        ...
        _$BenefitGrantGitHubRepositoryWebhookImpl(
          ...
          member: json['member'],
          benefit: BenefitGitHubRepository.fromJson(
              json['benefit'] as Map<String, dynamic>),
          properties: BenefitGrantGitHubRepositoryProperties.fromJson(
              json['properties'] as Map<String, dynamic>),
          previous_properties: json['previous_properties'],
        );

Map<String, dynamic> _$$BenefitGrantGitHubRepositoryWebhookImplToJson(
        _$BenefitGrantGitHubRepositoryWebhookImpl instance) =>
    <String, dynamic>{
