...
_$BenefitGrantLicenseKeysWebhookImpl
    _$$BenefitGrantLicenseKeysWebhookImplFromJson(Map<String, dynamic> json) =>
        _$BenefitGrantLicenseKeysWebhookImpl(
          ...
          member: json['member'],
          benefit: BenefitLicenseKeys.fromJson(
              json['benefit'] as Map<String, dynamic>),
          properties: BenefitGrantLicenseKeysProperties.fromJson(
              json['properties'] as Map<String, dynamic>),
          previous_properties: json['previous_properties'],
        );

Map<String, dynamic> _$$BenefitGrantLicenseKeysWebhookImplToJson(
        _$BenefitGrantLicenseKeysWebhookImpl instance) =>
    <String, dynamic>{
