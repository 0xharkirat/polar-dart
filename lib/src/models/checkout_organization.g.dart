...
_$CheckoutOrganizationImpl _$$CheckoutOrganizationImplFromJson(
        Map<String, dynamic> json) =>
    _$CheckoutOrganizationImpl(
...
Map<String, dynamic> _$$CheckoutOrganizationImplToJson(
        _$CheckoutOrganizationImpl instance) =>
    <String, dynamic>{
