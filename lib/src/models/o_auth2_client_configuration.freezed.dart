...
OAuth2ClientConfiguration _$OAuth2ClientConfigurationFromJson(
    Map<String, dynamic> json) {
  return _OAuth2ClientConfiguration.fromJson(json);
}

/// @nodoc
mixin _$OAuth2ClientConfiguration {
  ...
  $OAuth2ClientConfigurationCopyWith<OAuth2ClientConfiguration> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OAuth2ClientConfigurationCopyWith<$Res> {
  factory $OAuth2ClientConfigurationCopyWith(OAuth2ClientConfiguration value,
          $Res Function(OAuth2ClientConfiguration) then) =
      _$OAuth2ClientConfigurationCopyWithImpl<$Res, OAuth2ClientConfiguration>;
  @useResult
  $Res call(
...
/// @nodoc
class _$OAuth2ClientConfigurationCopyWithImpl<$Res,
        $Val extends OAuth2ClientConfiguration>
    implements $OAuth2ClientConfigurationCopyWith<$Res> {
  _$OAuth2ClientConfigurationCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OAuth2ClientConfigurationImplCopyWith<$Res>
    implements $OAuth2ClientConfigurationCopyWith<$Res> {
  factory _$$OAuth2ClientConfigurationImplCopyWith(
          _$OAuth2ClientConfigurationImpl value,
          $Res Function(_$OAuth2ClientConfigurationImpl) then) =
      __$$OAuth2ClientConfigurationImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<String> redirect_uris,
...
/// @nodoc
class __$$OAuth2ClientConfigurationImplCopyWithImpl<$Res>
    extends _$OAuth2ClientConfigurationCopyWithImpl<$Res,
        _$OAuth2ClientConfigurationImpl>
    implements _$$OAuth2ClientConfigurationImplCopyWith<$Res> {
  __$$OAuth2ClientConfigurationImplCopyWithImpl(
      _$OAuth2ClientConfigurationImpl _value,
      $Res Function(_$OAuth2ClientConfigurationImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$OAuth2ClientConfigurationImpl implements _OAuth2ClientConfiguration {
  const _$OAuth2ClientConfigurationImpl(
  ...
  factory _$OAuth2ClientConfigurationImpl.fromJson(Map<String, dynamic> json) =>
      _$$OAuth2ClientConfigurationImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OAuth2ClientConfigurationImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OAuth2ClientConfigurationImplCopyWith<_$OAuth2ClientConfigurationImpl>
      get copyWith => __$$OAuth2ClientConfigurationImplCopyWithImpl<
          _$OAuth2ClientConfigurationImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OAuth2ClientConfigurationImplToJson(
      this,
    );
  }
}

abstract class _OAuth2ClientConfiguration implements OAuth2ClientConfiguration {
  const factory _OAuth2ClientConfiguration(
      {required final List<String> redirect_uris,
      final String? token_endpoint_auth_method,
      final List<String>? grant_types,
      final List<String>? response_types,
