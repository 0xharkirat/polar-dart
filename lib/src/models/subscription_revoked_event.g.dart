...
_$SubscriptionRevokedEventImpl _$$SubscriptionRevokedEventImplFromJson(
    ...
    _$SubscriptionRevokedEventImpl(
      ...
      metadata: SubscriptionRevokedMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$SubscriptionRevokedEventImplToJson(
        _$SubscriptionRevokedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
