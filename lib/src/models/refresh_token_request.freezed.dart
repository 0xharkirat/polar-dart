...
class _$RefreshTokenRequestImpl implements _RefreshTokenRequest {
  ...
  @override
  String toString() {
    return 'RefreshTokenRequest(grant_type: $grant_type, client_id: $client_id, client_secret: $client_secret, refresh_token: $refresh_token)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, grant_type, client_id, client_secret, refresh_token);
...
abstract class _RefreshTokenRequest implements RefreshTokenRequest {
  const factory _RefreshTokenRequest(
      ...
      required final String refresh_token}) = _$RefreshTokenRequestImpl;
