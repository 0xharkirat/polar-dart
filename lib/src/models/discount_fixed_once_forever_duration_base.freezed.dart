...
DiscountFixedOnceForeverDurationBase
    _$DiscountFixedOnceForeverDurationBaseFromJson(Map<String, dynamic> json) {
  return _DiscountFixedOnceForeverDurationBase.fromJson(json);
}

/// @nodoc
mixin _$DiscountFixedOnceForeverDurationBase {
  ...
  /// Serializes this DiscountFixedOnceForeverDurationBase to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DiscountFixedOnceForeverDurationBase
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DiscountFixedOnceForeverDurationBaseCopyWith<
          DiscountFixedOnceForeverDurationBase>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DiscountFixedOnceForeverDurationBaseCopyWith<$Res> {
  factory $DiscountFixedOnceForeverDurationBaseCopyWith(
          DiscountFixedOnceForeverDurationBase value,
          $Res Function(DiscountFixedOnceForeverDurationBase) then) =
      _$DiscountFixedOnceForeverDurationBaseCopyWithImpl<$Res,
          DiscountFixedOnceForeverDurationBase>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DiscountFixedOnceForeverDurationBaseCopyWithImpl<$Res,
        $Val extends DiscountFixedOnceForeverDurationBase>
    implements $DiscountFixedOnceForeverDurationBaseCopyWith<$Res> {
  _$DiscountFixedOnceForeverDurationBaseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DiscountFixedOnceForeverDurationBaseImplCopyWith<$Res>
    implements $DiscountFixedOnceForeverDurationBaseCopyWith<$Res> {
  factory _$$DiscountFixedOnceForeverDurationBaseImplCopyWith(
          _$DiscountFixedOnceForeverDurationBaseImpl value,
          $Res Function(_$DiscountFixedOnceForeverDurationBaseImpl) then) =
      __$$DiscountFixedOnceForeverDurationBaseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {DiscountDuration duration,
...
/// @nodoc
class __$$DiscountFixedOnceForeverDurationBaseImplCopyWithImpl<$Res>
    extends _$DiscountFixedOnceForeverDurationBaseCopyWithImpl<$Res,
        _$DiscountFixedOnceForeverDurationBaseImpl>
    implements _$$DiscountFixedOnceForeverDurationBaseImplCopyWith<$Res> {
  __$$DiscountFixedOnceForeverDurationBaseImplCopyWithImpl(
      _$DiscountFixedOnceForeverDurationBaseImpl _value,
      $Res Function(_$DiscountFixedOnceForeverDurationBaseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DiscountFixedOnceForeverDurationBaseImpl(
      duration: null == duration
          ? _value.duration
          : duration // ignore: cast_nullable_to_non_nullable
              as DiscountDuration,
...
/// @nodoc
@JsonSerializable()
class _$DiscountFixedOnceForeverDurationBaseImpl
    implements _DiscountFixedOnceForeverDurationBase {
  const _$DiscountFixedOnceForeverDurationBaseImpl(
  ...
  factory _$DiscountFixedOnceForeverDurationBaseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$DiscountFixedOnceForeverDurationBaseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DiscountFixedOnceForeverDurationBase(duration: $duration, type: $type, amount: $amount, currency: $currency, amounts: $amounts, created_at: $created_at, modified_at: $modified_at, id: $id, metadata: $metadata, name: $name, code: $code, starts_at: $starts_at, ends_at: $ends_at, max_redemptions: $max_redemptions, redemptions_count: $redemptions_count, organization_id: $organization_id)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DiscountFixedOnceForeverDurationBaseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DiscountFixedOnceForeverDurationBaseImplCopyWith<
          _$DiscountFixedOnceForeverDurationBaseImpl>
      get copyWith => __$$DiscountFixedOnceForeverDurationBaseImplCopyWithImpl<
          _$DiscountFixedOnceForeverDurationBaseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DiscountFixedOnceForeverDurationBaseImplToJson(
      this,
    );
  }
}

abstract class _DiscountFixedOnceForeverDurationBase
    implements DiscountFixedOnceForeverDurationBase {
  const factory _DiscountFixedOnceForeverDurationBase(
  ...
  factory _DiscountFixedOnceForeverDurationBase.fromJson(
          Map<String, dynamic> json) =
      _$DiscountFixedOnceForeverDurationBaseImpl.fromJson;
