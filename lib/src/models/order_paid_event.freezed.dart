...
OrderPaidEvent _$OrderPaidEventFromJson(Map<String, dynamic> json) {
  return _OrderPaidEvent.fromJson(json);
}

/// @nodoc
mixin _$OrderPaidEvent {
  ...
  OrderPaidMetadata get metadata => throw _privateConstructorUsedError;

  /// Serializes this OrderPaidEvent to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of OrderPaidEvent
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $OrderPaidEventCopyWith<OrderPaidEvent> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OrderPaidEventCopyWith<$Res> {
  factory $OrderPaidEventCopyWith(
          OrderPaidEvent value, $Res Function(OrderPaidEvent) then) =
      _$OrderPaidEventCopyWithImpl<$Res, OrderPaidEvent>;
  @useResult
  $Res call(
      {String id,
      String timestamp,
      ...
      String source,
      String name,
      OrderPaidMetadata metadata});

  $OrderPaidMetadataCopyWith<$Res> get metadata;
}

/// @nodoc
class _$OrderPaidEventCopyWithImpl<$Res, $Val extends OrderPaidEvent>
    implements $OrderPaidEventCopyWith<$Res> {
  _$OrderPaidEventCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $OrderPaidMetadataCopyWith<$Res> get metadata {
    return $OrderPaidMetadataCopyWith<$Res>(_value.metadata, (value) {
...
/// @nodoc
abstract class _$$OrderPaidEventImplCopyWith<$Res>
    implements $OrderPaidEventCopyWith<$Res> {
  factory _$$OrderPaidEventImplCopyWith(_$OrderPaidEventImpl value,
          $Res Function(_$OrderPaidEventImpl) then) =
      __$$OrderPaidEventImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$OrderPaidEventImplCopyWithImpl<$Res>
    extends _$OrderPaidEventCopyWithImpl<$Res, _$OrderPaidEventImpl>
    implements _$$OrderPaidEventImplCopyWith<$Res> {
  __$$OrderPaidEventImplCopyWithImpl(
      _$OrderPaidEventImpl _value, $Res Function(_$OrderPaidEventImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OrderPaidEventImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$OrderPaidEventImpl implements _OrderPaidEvent {
  const _$OrderPaidEventImpl(
      {required this.id,
  ...
  factory _$OrderPaidEventImpl.fromJson(Map<String, dynamic> json) =>
      _$$OrderPaidEventImplFromJson(json);
  ...
  final String name;
  @override
  final OrderPaidMetadata metadata;

  @override
  String toString() {
    return 'OrderPaidEvent(id: $id, timestamp: $timestamp, organization_id: $organization_id, customer_id: $customer_id, customer: $customer, external_customer_id: $external_customer_id, member_id: $member_id, external_member_id: $external_member_id, child_count: $child_count, parent_id: $parent_id, label: $label, source: $source, name: $name, metadata: $metadata)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OrderPaidEventImplCopyWith<_$OrderPaidEventImpl> get copyWith =>
      __$$OrderPaidEventImplCopyWithImpl<_$OrderPaidEventImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OrderPaidEventImplToJson(
      this,
    );
  }
}

abstract class _OrderPaidEvent implements OrderPaidEvent {
  const factory _OrderPaidEvent(
      ...
      required final OrderPaidMetadata metadata}) = _$OrderPaidEventImpl;

  factory _OrderPaidEvent.fromJson(Map<String, dynamic> json) =
      _$OrderPaidEventImpl.fromJson;
  ...
  String get name;
  @override
  OrderPaidMetadata get metadata;
