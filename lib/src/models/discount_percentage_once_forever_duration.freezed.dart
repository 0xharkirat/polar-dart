...
DiscountPercentageOnceForeverDuration
    _$DiscountPercentageOnceForeverDurationFromJson(Map<String, dynamic> json) {
  return _DiscountPercentageOnceForeverDuration.fromJson(json);
}

/// @nodoc
mixin _$DiscountPercentageOnceForeverDuration {
  ...
  /// Serializes this DiscountPercentageOnceForeverDuration to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DiscountPercentageOnceForeverDuration
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DiscountPercentageOnceForeverDurationCopyWith<
          DiscountPercentageOnceForeverDuration>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DiscountPercentageOnceForeverDurationCopyWith<$Res> {
  factory $DiscountPercentageOnceForeverDurationCopyWith(
          DiscountPercentageOnceForeverDuration value,
          $Res Function(DiscountPercentageOnceForeverDuration) then) =
      _$DiscountPercentageOnceForeverDurationCopyWithImpl<$Res,
          DiscountPercentageOnceForeverDuration>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DiscountPercentageOnceForeverDurationCopyWithImpl<$Res,
        $Val extends DiscountPercentageOnceForeverDuration>
    implements $DiscountPercentageOnceForeverDurationCopyWith<$Res> {
  _$DiscountPercentageOnceForeverDurationCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DiscountPercentageOnceForeverDurationImplCopyWith<$Res>
    implements $DiscountPercentageOnceForeverDurationCopyWith<$Res> {
  factory _$$DiscountPercentageOnceForeverDurationImplCopyWith(
          _$DiscountPercentageOnceForeverDurationImpl value,
          $Res Function(_$DiscountPercentageOnceForeverDurationImpl) then) =
      __$$DiscountPercentageOnceForeverDurationImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {DiscountDuration duration,
...
/// @nodoc
class __$$DiscountPercentageOnceForeverDurationImplCopyWithImpl<$Res>
    extends _$DiscountPercentageOnceForeverDurationCopyWithImpl<$Res,
        _$DiscountPercentageOnceForeverDurationImpl>
    implements _$$DiscountPercentageOnceForeverDurationImplCopyWith<$Res> {
  __$$DiscountPercentageOnceForeverDurationImplCopyWithImpl(
      _$DiscountPercentageOnceForeverDurationImpl _value,
      $Res Function(_$DiscountPercentageOnceForeverDurationImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DiscountPercentageOnceForeverDurationImpl(
      duration: null == duration
          ? _value.duration
          : duration // ignore: cast_nullable_to_non_nullable
              as DiscountDuration,
...
/// @nodoc
@JsonSerializable()
class _$DiscountPercentageOnceForeverDurationImpl
    implements _DiscountPercentageOnceForeverDuration {
  const _$DiscountPercentageOnceForeverDurationImpl(
  ...
  factory _$DiscountPercentageOnceForeverDurationImpl.fromJson(
      ...
      _$$DiscountPercentageOnceForeverDurationImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DiscountPercentageOnceForeverDuration(duration: $duration, type: $type, basis_points: $basis_points, created_at: $created_at, modified_at: $modified_at, id: $id, metadata: $metadata, name: $name, code: $code, starts_at: $starts_at, ends_at: $ends_at, max_redemptions: $max_redemptions, redemptions_count: $redemptions_count, organization_id: $organization_id, products: $products)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DiscountPercentageOnceForeverDurationImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DiscountPercentageOnceForeverDurationImplCopyWith<
          _$DiscountPercentageOnceForeverDurationImpl>
      get copyWith => __$$DiscountPercentageOnceForeverDurationImplCopyWithImpl<
          _$DiscountPercentageOnceForeverDurationImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DiscountPercentageOnceForeverDurationImplToJson(
      this,
    );
  }
}

abstract class _DiscountPercentageOnceForeverDuration
    implements DiscountPercentageOnceForeverDuration {
  const factory _DiscountPercentageOnceForeverDuration(
  ...
  factory _DiscountPercentageOnceForeverDuration.fromJson(
          Map<String, dynamic> json) =
      _$DiscountPercentageOnceForeverDurationImpl.fromJson;
