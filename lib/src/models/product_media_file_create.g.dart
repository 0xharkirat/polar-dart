...
_$ProductMediaFileCreateImpl _$$ProductMediaFileCreateImplFromJson(
...
Map<String, dynamic> _$$ProductMediaFileCreateImplToJson(
        _$ProductMediaFileCreateImpl instance) =>
    <String, dynamic>{
