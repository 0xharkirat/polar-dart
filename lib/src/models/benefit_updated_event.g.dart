...
_$BenefitUpdatedEventImpl _$$BenefitUpdatedEventImplFromJson(
    ...
    _$BenefitUpdatedEventImpl(
      ...
      metadata: BenefitGrantMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$BenefitUpdatedEventImplToJson(
        _$BenefitUpdatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
