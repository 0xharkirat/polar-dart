...
part of 'discount_percentage_repeat_duration_base.dart';
...
DiscountPercentageRepeatDurationBase
    _$DiscountPercentageRepeatDurationBaseFromJson(Map<String, dynamic> json) {
  return _DiscountPercentageRepeatDurationBase.fromJson(json);
}

/// @nodoc
mixin _$DiscountPercentageRepeatDurationBase {
  ...
  /// Serializes this DiscountPercentageRepeatDurationBase to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DiscountPercentageRepeatDurationBase
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DiscountPercentageRepeatDurationBaseCopyWith<
          DiscountPercentageRepeatDurationBase>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DiscountPercentageRepeatDurationBaseCopyWith<$Res> {
  factory $DiscountPercentageRepeatDurationBaseCopyWith(
          DiscountPercentageRepeatDurationBase value,
          $Res Function(DiscountPercentageRepeatDurationBase) then) =
      _$DiscountPercentageRepeatDurationBaseCopyWithImpl<$Res,
          DiscountPercentageRepeatDurationBase>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DiscountPercentageRepeatDurationBaseCopyWithImpl<$Res,
        $Val extends DiscountPercentageRepeatDurationBase>
    implements $DiscountPercentageRepeatDurationBaseCopyWith<$Res> {
  _$DiscountPercentageRepeatDurationBaseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DiscountPercentageRepeatDurationBaseImplCopyWith<$Res>
    implements $DiscountPercentageRepeatDurationBaseCopyWith<$Res> {
  factory _$$DiscountPercentageRepeatDurationBaseImplCopyWith(
          _$DiscountPercentageRepeatDurationBaseImpl value,
          $Res Function(_$DiscountPercentageRepeatDurationBaseImpl) then) =
      __$$DiscountPercentageRepeatDurationBaseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {DiscountDuration duration,
...
/// @nodoc
class __$$DiscountPercentageRepeatDurationBaseImplCopyWithImpl<$Res>
    extends _$DiscountPercentageRepeatDurationBaseCopyWithImpl<$Res,
        _$DiscountPercentageRepeatDurationBaseImpl>
    implements _$$DiscountPercentageRepeatDurationBaseImplCopyWith<$Res> {
  __$$DiscountPercentageRepeatDurationBaseImplCopyWithImpl(
      _$DiscountPercentageRepeatDurationBaseImpl _value,
      $Res Function(_$DiscountPercentageRepeatDurationBaseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DiscountPercentageRepeatDurationBaseImpl(
      duration: null == duration
          ? _value.duration
          : duration // ignore: cast_nullable_to_non_nullable
              as DiscountDuration,
...
/// @nodoc
@JsonSerializable()
class _$DiscountPercentageRepeatDurationBaseImpl
    implements _DiscountPercentageRepeatDurationBase {
  const _$DiscountPercentageRepeatDurationBaseImpl(
  ...
  factory _$DiscountPercentageRepeatDurationBaseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$DiscountPercentageRepeatDurationBaseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DiscountPercentageRepeatDurationBase(duration: $duration, duration_in_months: $duration_in_months, type: $type, basis_points: $basis_points, created_at: $created_at, modified_at: $modified_at, id: $id, metadata: $metadata, name: $name, code: $code, starts_at: $starts_at, ends_at: $ends_at, max_redemptions: $max_redemptions, redemptions_count: $redemptions_count, organization_id: $organization_id)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DiscountPercentageRepeatDurationBaseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DiscountPercentageRepeatDurationBaseImplCopyWith<
          _$DiscountPercentageRepeatDurationBaseImpl>
      get copyWith => __$$DiscountPercentageRepeatDurationBaseImplCopyWithImpl<
          _$DiscountPercentageRepeatDurationBaseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DiscountPercentageRepeatDurationBaseImplToJson(
      this,
    );
  }
}

abstract class _DiscountPercentageRepeatDurationBase
    implements DiscountPercentageRepeatDurationBase {
  const factory _DiscountPercentageRepeatDurationBase(
  ...
  factory _DiscountPercentageRepeatDurationBase.fromJson(
          Map<String, dynamic> json) =
      _$DiscountPercentageRepeatDurationBaseImpl.fromJson;
