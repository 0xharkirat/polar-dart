...
_$BalanceCreditOrderEventImpl _$$BalanceCreditOrderEventImplFromJson(
    ...
    _$BalanceCreditOrderEventImpl(
      ...
      metadata: BalanceCreditOrderMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$BalanceCreditOrderEventImplToJson(
        _$BalanceCreditOrderEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
