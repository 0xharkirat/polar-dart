...
_$BenefitCycledEventImpl _$$BenefitCycledEventImplFromJson(
        Map<String, dynamic> json) =>
    _$BenefitCycledEventImpl(
...
Map<String, dynamic> _$$BenefitCycledEventImplToJson(
        _$BenefitCycledEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
