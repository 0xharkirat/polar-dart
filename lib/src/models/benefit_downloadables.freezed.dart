...
BenefitDownloadables _$BenefitDownloadablesFromJson(Map<String, dynamic> json) {
  return _BenefitDownloadables.fromJson(json);
}
...
mixin _$BenefitDownloadables {
  ...
  /// Serializes this BenefitDownloadables to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BenefitDownloadables
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BenefitDownloadablesCopyWith<BenefitDownloadables> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BenefitDownloadablesCopyWith<$Res> {
  factory $BenefitDownloadablesCopyWith(BenefitDownloadables value,
          $Res Function(BenefitDownloadables) then) =
...
/// @nodoc
class _$BenefitDownloadablesCopyWithImpl<$Res,
        $Val extends BenefitDownloadables>
    implements $BenefitDownloadablesCopyWith<$Res> {
  _$BenefitDownloadablesCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $BenefitDownloadablesPropertiesCopyWith<$Res> get properties {
    return $BenefitDownloadablesPropertiesCopyWith<$Res>(_value.properties,
        (value) {
...
/// @nodoc
abstract class _$$BenefitDownloadablesImplCopyWith<$Res>
    implements $BenefitDownloadablesCopyWith<$Res> {
  factory _$$BenefitDownloadablesImplCopyWith(_$BenefitDownloadablesImpl value,
          $Res Function(_$BenefitDownloadablesImpl) then) =
      __$$BenefitDownloadablesImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$BenefitDownloadablesImplCopyWithImpl<$Res>
    extends _$BenefitDownloadablesCopyWithImpl<$Res, _$BenefitDownloadablesImpl>
    implements _$$BenefitDownloadablesImplCopyWith<$Res> {
  __$$BenefitDownloadablesImplCopyWithImpl(_$BenefitDownloadablesImpl _value,
      $Res Function(_$BenefitDownloadablesImpl) _then)
      : super(_value, _then);
...
class _$BenefitDownloadablesImpl implements _BenefitDownloadables {
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BenefitDownloadablesImplCopyWith<_$BenefitDownloadablesImpl>
      get copyWith =>
          __$$BenefitDownloadablesImplCopyWithImpl<_$BenefitDownloadablesImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BenefitDownloadablesImplToJson(
      this,
    );
  }
}
...
abstract class _BenefitDownloadables implements BenefitDownloadables {
  ...
  factory _BenefitDownloadables.fromJson(Map<String, dynamic> json) =
