...
_$SubscriptionMeterImpl _$$SubscriptionMeterImplFromJson(
        Map<String, dynamic> json) =>
    _$SubscriptionMeterImpl(
...
Map<String, dynamic> _$$SubscriptionMeterImplToJson(
        _$SubscriptionMeterImpl instance) =>
    <String, dynamic>{
