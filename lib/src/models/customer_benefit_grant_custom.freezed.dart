...
CustomerBenefitGrantCustom _$CustomerBenefitGrantCustomFromJson(
    Map<String, dynamic> json) {
  return _CustomerBenefitGrantCustom.fromJson(json);
}

/// @nodoc
mixin _$CustomerBenefitGrantCustom {
  ...
  /// Serializes this CustomerBenefitGrantCustom to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CustomerBenefitGrantCustom
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CustomerBenefitGrantCustomCopyWith<CustomerBenefitGrantCustom>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CustomerBenefitGrantCustomCopyWith<$Res> {
  factory $CustomerBenefitGrantCustomCopyWith(CustomerBenefitGrantCustom value,
          $Res Function(CustomerBenefitGrantCustom) then) =
      _$CustomerBenefitGrantCustomCopyWithImpl<$Res,
  ...
  $BenefitCustomSubscriberCopyWith<$Res> get benefit;
}

/// @nodoc
class _$CustomerBenefitGrantCustomCopyWithImpl<$Res,
        $Val extends CustomerBenefitGrantCustom>
    implements $CustomerBenefitGrantCustomCopyWith<$Res> {
  _$CustomerBenefitGrantCustomCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $BenefitCustomSubscriberCopyWith<$Res> get benefit {
    return $BenefitCustomSubscriberCopyWith<$Res>(_value.benefit, (value) {
...
/// @nodoc
abstract class _$$CustomerBenefitGrantCustomImplCopyWith<$Res>
    implements $CustomerBenefitGrantCustomCopyWith<$Res> {
  factory _$$CustomerBenefitGrantCustomImplCopyWith(
          _$CustomerBenefitGrantCustomImpl value,
          $Res Function(_$CustomerBenefitGrantCustomImpl) then) =
      __$$CustomerBenefitGrantCustomImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$CustomerBenefitGrantCustomImplCopyWithImpl<$Res>
    extends _$CustomerBenefitGrantCustomCopyWithImpl<$Res,
        _$CustomerBenefitGrantCustomImpl>
    implements _$$CustomerBenefitGrantCustomImplCopyWith<$Res> {
  __$$CustomerBenefitGrantCustomImplCopyWithImpl(
      _$CustomerBenefitGrantCustomImpl _value,
      $Res Function(_$CustomerBenefitGrantCustomImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CustomerBenefitGrantCustomImpl(
      created_at: null == created_at
          ? _value.created_at
          : created_at // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CustomerBenefitGrantCustomImpl implements _CustomerBenefitGrantCustom {
  const _$CustomerBenefitGrantCustomImpl(
  ...
  factory _$CustomerBenefitGrantCustomImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CustomerBenefitGrantCustomImplFromJson(json);
  ...
  @override
  final BenefitCustomSubscriber benefit;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CustomerBenefitGrantCustomImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CustomerBenefitGrantCustomImplCopyWith<_$CustomerBenefitGrantCustomImpl>
      get copyWith => __$$CustomerBenefitGrantCustomImplCopyWithImpl<
          _$CustomerBenefitGrantCustomImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CustomerBenefitGrantCustomImplToJson(
      this,
    );
  }
}

abstract class _CustomerBenefitGrantCustom
    implements CustomerBenefitGrantCustom {
  const factory _CustomerBenefitGrantCustom(
  ...
  factory _CustomerBenefitGrantCustom.fromJson(Map<String, dynamic> json) =
      _$CustomerBenefitGrantCustomImpl.fromJson;
  ...
  @override
  BenefitCustomSubscriber get benefit;
  @override
  Map<String, dynamic> get properties;
