...
_$CheckoutCreatedEventImpl _$$CheckoutCreatedEventImplFromJson(
    ...
    _$CheckoutCreatedEventImpl(
      ...
      metadata: CheckoutCreatedMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$CheckoutCreatedEventImplToJson(
        _$CheckoutCreatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
