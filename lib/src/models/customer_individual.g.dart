...
_$CustomerIndividualImpl _$$CustomerIndividualImplFromJson(
        Map<String, dynamic> json) =>
    _$CustomerIndividualImpl(
...
Map<String, dynamic> _$$CustomerIndividualImplToJson(
        _$CustomerIndividualImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
