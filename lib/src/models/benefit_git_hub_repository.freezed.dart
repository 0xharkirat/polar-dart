...
BenefitGitHubRepository _$BenefitGitHubRepositoryFromJson(
    Map<String, dynamic> json) {
  return _BenefitGitHubRepository.fromJson(json);
}
...
mixin _$BenefitGitHubRepository {
  ...
  /// Serializes this BenefitGitHubRepository to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BenefitGitHubRepository
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BenefitGitHubRepositoryCopyWith<BenefitGitHubRepository> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BenefitGitHubRepositoryCopyWith<$Res> {
  factory $BenefitGitHubRepositoryCopyWith(BenefitGitHubRepository value,
          $Res Function(BenefitGitHubRepository) then) =
...
/// @nodoc
class _$BenefitGitHubRepositoryCopyWithImpl<$Res,
        $Val extends BenefitGitHubRepository>
    implements $BenefitGitHubRepositoryCopyWith<$Res> {
  _$BenefitGitHubRepositoryCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $BenefitGitHubRepositoryPropertiesCopyWith<$Res> get properties {
    return $BenefitGitHubRepositoryPropertiesCopyWith<$Res>(_value.properties,
        (value) {
...
/// @nodoc
abstract class _$$BenefitGitHubRepositoryImplCopyWith<$Res>
    implements $BenefitGitHubRepositoryCopyWith<$Res> {
  factory _$$BenefitGitHubRepositoryImplCopyWith(
          _$BenefitGitHubRepositoryImpl value,
          $Res Function(_$BenefitGitHubRepositoryImpl) then) =
      __$$BenefitGitHubRepositoryImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$BenefitGitHubRepositoryImplCopyWithImpl<$Res>
    extends _$BenefitGitHubRepositoryCopyWithImpl<$Res,
        _$BenefitGitHubRepositoryImpl>
    implements _$$BenefitGitHubRepositoryImplCopyWith<$Res> {
  __$$BenefitGitHubRepositoryImplCopyWithImpl(
      _$BenefitGitHubRepositoryImpl _value,
      $Res Function(_$BenefitGitHubRepositoryImpl) _then)
      : super(_value, _then);
...
class _$BenefitGitHubRepositoryImpl implements _BenefitGitHubRepository {
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BenefitGitHubRepositoryImplCopyWith<_$BenefitGitHubRepositoryImpl>
      get copyWith => __$$BenefitGitHubRepositoryImplCopyWithImpl<
          _$BenefitGitHubRepositoryImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BenefitGitHubRepositoryImplToJson(
      this,
    );
  }
}
...
abstract class _BenefitGitHubRepository implements BenefitGitHubRepository {
  ...
  factory _BenefitGitHubRepository.fromJson(Map<String, dynamic> json) =
