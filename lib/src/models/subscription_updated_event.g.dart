...
_$SubscriptionUpdatedEventImpl _$$SubscriptionUpdatedEventImplFromJson(
...
Map<String, dynamic> _$$SubscriptionUpdatedEventImplToJson(
        _$SubscriptionUpdatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
