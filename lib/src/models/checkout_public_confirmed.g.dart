...
_$CheckoutPublicConfirmedImpl _$$CheckoutPublicConfirmedImplFromJson(
    ...
    _$CheckoutPublicConfirmedImpl(
      ...
      organization: CheckoutOrganization.fromJson(
          json['organization'] as Map<String, dynamic>),
      attached_custom_fields: json['attached_custom_fields'],
      customer_session_token: json['customer_session_token'] as String?,
    );

Map<String, dynamic> _$$CheckoutPublicConfirmedImplToJson(
        _$CheckoutPublicConfirmedImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      if (instance.customer_session_token case final value?)
        'customer_session_token': value,
    };
