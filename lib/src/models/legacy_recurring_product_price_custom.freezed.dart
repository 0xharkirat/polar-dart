...
LegacyRecurringProductPriceCustom _$LegacyRecurringProductPriceCustomFromJson(
    Map<String, dynamic> json) {
  return _LegacyRecurringProductPriceCustom.fromJson(json);
}

/// @nodoc
mixin _$LegacyRecurringProductPriceCustom {
  ...
  /// Serializes this LegacyRecurringProductPriceCustom to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of LegacyRecurringProductPriceCustom
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $LegacyRecurringProductPriceCustomCopyWith<LegacyRecurringProductPriceCustom>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LegacyRecurringProductPriceCustomCopyWith<$Res> {
  factory $LegacyRecurringProductPriceCustomCopyWith(
          LegacyRecurringProductPriceCustom value,
          $Res Function(LegacyRecurringProductPriceCustom) then) =
      _$LegacyRecurringProductPriceCustomCopyWithImpl<$Res,
...
/// @nodoc
class _$LegacyRecurringProductPriceCustomCopyWithImpl<$Res,
        $Val extends LegacyRecurringProductPriceCustom>
    implements $LegacyRecurringProductPriceCustomCopyWith<$Res> {
  _$LegacyRecurringProductPriceCustomCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$LegacyRecurringProductPriceCustomImplCopyWith<$Res>
    implements $LegacyRecurringProductPriceCustomCopyWith<$Res> {
  factory _$$LegacyRecurringProductPriceCustomImplCopyWith(
          _$LegacyRecurringProductPriceCustomImpl value,
          $Res Function(_$LegacyRecurringProductPriceCustomImpl) then) =
      __$$LegacyRecurringProductPriceCustomImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$LegacyRecurringProductPriceCustomImplCopyWithImpl<$Res>
    extends _$LegacyRecurringProductPriceCustomCopyWithImpl<$Res,
        _$LegacyRecurringProductPriceCustomImpl>
    implements _$$LegacyRecurringProductPriceCustomImplCopyWith<$Res> {
  __$$LegacyRecurringProductPriceCustomImplCopyWithImpl(
      _$LegacyRecurringProductPriceCustomImpl _value,
      $Res Function(_$LegacyRecurringProductPriceCustomImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$LegacyRecurringProductPriceCustomImpl(
      created_at: null == created_at
          ? _value.created_at
          : created_at // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$LegacyRecurringProductPriceCustomImpl
    implements _LegacyRecurringProductPriceCustom {
  const _$LegacyRecurringProductPriceCustomImpl(
  ...
  factory _$LegacyRecurringProductPriceCustomImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$LegacyRecurringProductPriceCustomImplFromJson(json);
  ...
  @override
  String toString() {
    return 'LegacyRecurringProductPriceCustom(created_at: $created_at, modified_at: $modified_at, id: $id, source: $source, amount_type: $amount_type, price_currency: $price_currency, tax_behavior: $tax_behavior, is_archived: $is_archived, product_id: $product_id, type: $type, recurring_interval: $recurring_interval, minimum_amount: $minimum_amount, maximum_amount: $maximum_amount, preset_amount: $preset_amount, legacy: $legacy)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$LegacyRecurringProductPriceCustomImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LegacyRecurringProductPriceCustomImplCopyWith<
          _$LegacyRecurringProductPriceCustomImpl>
      get copyWith => __$$LegacyRecurringProductPriceCustomImplCopyWithImpl<
          _$LegacyRecurringProductPriceCustomImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LegacyRecurringProductPriceCustomImplToJson(
      this,
    );
  }
}

abstract class _LegacyRecurringProductPriceCustom
    implements LegacyRecurringProductPriceCustom {
  const factory _LegacyRecurringProductPriceCustom(
      ...
      required final int minimum_amount,
      required final dynamic maximum_amount,
      required final dynamic preset_amount,
      required final bool legacy}) = _$LegacyRecurringProductPriceCustomImpl;

  factory _LegacyRecurringProductPriceCustom.fromJson(
          Map<String, dynamic> json) =
      _$LegacyRecurringProductPriceCustomImpl.fromJson;
