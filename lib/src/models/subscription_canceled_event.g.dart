...
_$SubscriptionCanceledEventImpl _$$SubscriptionCanceledEventImplFromJson(
    ...
    _$SubscriptionCanceledEventImpl(
      ...
      metadata: SubscriptionCanceledMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$SubscriptionCanceledEventImplToJson(
        _$SubscriptionCanceledEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
