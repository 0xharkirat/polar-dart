...
part of 'product_media_file_read.dart';
...
ProductMediaFileRead _$ProductMediaFileReadFromJson(Map<String, dynamic> json) {
  return _ProductMediaFileRead.fromJson(json);
}

/// @nodoc
mixin _$ProductMediaFileRead {
  ...
  /// Serializes this ProductMediaFileRead to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ProductMediaFileRead
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ProductMediaFileReadCopyWith<ProductMediaFileRead> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProductMediaFileReadCopyWith<$Res> {
  factory $ProductMediaFileReadCopyWith(ProductMediaFileRead value,
          $Res Function(ProductMediaFileRead) then) =
      _$ProductMediaFileReadCopyWithImpl<$Res, ProductMediaFileRead>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$ProductMediaFileReadCopyWithImpl<$Res,
        $Val extends ProductMediaFileRead>
    implements $ProductMediaFileReadCopyWith<$Res> {
  _$ProductMediaFileReadCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProductMediaFileReadImplCopyWith<$Res>
    implements $ProductMediaFileReadCopyWith<$Res> {
  factory _$$ProductMediaFileReadImplCopyWith(_$ProductMediaFileReadImpl value,
          $Res Function(_$ProductMediaFileReadImpl) then) =
      __$$ProductMediaFileReadImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$ProductMediaFileReadImplCopyWithImpl<$Res>
    extends _$ProductMediaFileReadCopyWithImpl<$Res, _$ProductMediaFileReadImpl>
    implements _$$ProductMediaFileReadImplCopyWith<$Res> {
  __$$ProductMediaFileReadImplCopyWithImpl(_$ProductMediaFileReadImpl _value,
      $Res Function(_$ProductMediaFileReadImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProductMediaFileReadImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$ProductMediaFileReadImpl implements _ProductMediaFileRead {
  const _$ProductMediaFileReadImpl(
      {required this.id,
  ...
  factory _$ProductMediaFileReadImpl.fromJson(Map<String, dynamic> json) =>
      _$$ProductMediaFileReadImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ProductMediaFileReadImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProductMediaFileReadImplCopyWith<_$ProductMediaFileReadImpl>
      get copyWith =>
          __$$ProductMediaFileReadImplCopyWithImpl<_$ProductMediaFileReadImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ProductMediaFileReadImplToJson(
      this,
    );
  }
}

abstract class _ProductMediaFileRead implements ProductMediaFileRead {
  const factory _ProductMediaFileRead(
      ...
      required final String size_readable,
      required final String public_url}) = _$ProductMediaFileReadImpl;

  factory _ProductMediaFileRead.fromJson(Map<String, dynamic> json) =
      _$ProductMediaFileReadImpl.fromJson;
