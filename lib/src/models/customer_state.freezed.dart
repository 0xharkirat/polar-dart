...
mixin _$CustomerState {
  ...
  /// Serializes this CustomerState to a JSON map.
...
class _$CustomerStateImpl implements _CustomerState {
  ...
  factory _$CustomerStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$CustomerStateImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CustomerState(additionalProperties: $additionalProperties)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$CustomerStateImplToJson(
      this,
    );
  }
}
...
abstract class _CustomerState implements CustomerState {
  const factory _CustomerState(
      {final Map<String, dynamic> additionalProperties}) = _$CustomerStateImpl;

  factory _CustomerState.fromJson(Map<String, dynamic> json) =
      _$CustomerStateImpl.fromJson;
