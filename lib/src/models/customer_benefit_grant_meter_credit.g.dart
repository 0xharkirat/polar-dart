...
_$CustomerBenefitGrantMeterCreditImpl
    _$$CustomerBenefitGrantMeterCreditImplFromJson(Map<String, dynamic> json) =>
        _$CustomerBenefitGrantMeterCreditImpl(
          ...
          benefit: BenefitMeterCreditSubscriber.fromJson(
              json['benefit'] as Map<String, dynamic>),
          properties: BenefitGrantMeterCreditProperties.fromJson(
              json['properties'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$$CustomerBenefitGrantMeterCreditImplToJson(
        _$CustomerBenefitGrantMeterCreditImpl instance) =>
    <String, dynamic>{
