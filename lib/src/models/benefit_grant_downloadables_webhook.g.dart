...
_$BenefitGrantDownloadablesWebhookImpl
    _$$BenefitGrantDownloadablesWebhookImplFromJson(
        ...
        _$BenefitGrantDownloadablesWebhookImpl(
          ...
          member: json['member'],
          benefit: BenefitDownloadables.fromJson(
...
Map<String, dynamic> _$$BenefitGrantDownloadablesWebhookImplToJson(
        _$BenefitGrantDownloadablesWebhookImpl instance) =>
    <String, dynamic>{
