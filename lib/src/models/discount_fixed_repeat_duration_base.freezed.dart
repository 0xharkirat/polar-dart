...
class _$DiscountFixedRepeatDurationBaseImpl
  ...
  @override
  String toString() {
    return 'DiscountFixedRepeatDurationBase(duration: $duration, duration_in_months: $duration_in_months, type: $type, amount: $amount, currency: $currency, amounts: $amounts, created_at: $created_at, modified_at: $modified_at, id: $id, metadata: $metadata, name: $name, code: $code, starts_at: $starts_at, ends_at: $ends_at, max_redemptions: $max_redemptions, redemptions_count: $redemptions_count, organization_id: $organization_id)';
  }
