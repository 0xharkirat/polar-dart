...
mixin _$FileDownload {
  ...
  S3DownloadURL get download => throw _privateConstructorUsedError;
  ...
  /// Serializes this FileDownload to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of FileDownload
...
abstract class $FileDownloadCopyWith<$Res> {
  ...
  $Res call(
      ...
      S3DownloadURL download,
      String? version,
      bool is_uploaded,
      FileServiceTypes service,
      String size_readable});

  $S3DownloadURLCopyWith<$Res> get download;
}
...
class _$FileDownloadCopyWithImpl<$Res, $Val extends FileDownload>
  ...
  @pragma('vm:prefer-inline')
  $S3DownloadURLCopyWith<$Res> get download {
    return $S3DownloadURLCopyWith<$Res>(_value.download, (value) {
...
class _$FileDownloadImpl implements _FileDownload {
  ...
  factory _$FileDownloadImpl.fromJson(Map<String, dynamic> json) =>
      _$$FileDownloadImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$FileDownloadImplToJson(
      this,
    );
  }
}
