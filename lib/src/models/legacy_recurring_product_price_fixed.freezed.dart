...
LegacyRecurringProductPriceFixed _$LegacyRecurringProductPriceFixedFromJson(
    Map<String, dynamic> json) {
  return _LegacyRecurringProductPriceFixed.fromJson(json);
}

/// @nodoc
mixin _$LegacyRecurringProductPriceFixed {
  ...
  /// Serializes this LegacyRecurringProductPriceFixed to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of LegacyRecurringProductPriceFixed
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $LegacyRecurringProductPriceFixedCopyWith<LegacyRecurringProductPriceFixed>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LegacyRecurringProductPriceFixedCopyWith<$Res> {
  factory $LegacyRecurringProductPriceFixedCopyWith(
          LegacyRecurringProductPriceFixed value,
          $Res Function(LegacyRecurringProductPriceFixed) then) =
      _$LegacyRecurringProductPriceFixedCopyWithImpl<$Res,
...
/// @nodoc
class _$LegacyRecurringProductPriceFixedCopyWithImpl<$Res,
        $Val extends LegacyRecurringProductPriceFixed>
    implements $LegacyRecurringProductPriceFixedCopyWith<$Res> {
  _$LegacyRecurringProductPriceFixedCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$LegacyRecurringProductPriceFixedImplCopyWith<$Res>
    implements $LegacyRecurringProductPriceFixedCopyWith<$Res> {
  factory _$$LegacyRecurringProductPriceFixedImplCopyWith(
          _$LegacyRecurringProductPriceFixedImpl value,
          $Res Function(_$LegacyRecurringProductPriceFixedImpl) then) =
      __$$LegacyRecurringProductPriceFixedImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String created_at,
...
/// @nodoc
class __$$LegacyRecurringProductPriceFixedImplCopyWithImpl<$Res>
    extends _$LegacyRecurringProductPriceFixedCopyWithImpl<$Res,
        _$LegacyRecurringProductPriceFixedImpl>
    implements _$$LegacyRecurringProductPriceFixedImplCopyWith<$Res> {
  __$$LegacyRecurringProductPriceFixedImplCopyWithImpl(
      _$LegacyRecurringProductPriceFixedImpl _value,
      $Res Function(_$LegacyRecurringProductPriceFixedImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$LegacyRecurringProductPriceFixedImpl(
      created_at: null == created_at
          ? _value.created_at
          : created_at // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$LegacyRecurringProductPriceFixedImpl
    implements _LegacyRecurringProductPriceFixed {
  const _$LegacyRecurringProductPriceFixedImpl(
  ...
  factory _$LegacyRecurringProductPriceFixedImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$LegacyRecurringProductPriceFixedImplFromJson(json);
  ...
  @override
  String toString() {
    return 'LegacyRecurringProductPriceFixed(created_at: $created_at, modified_at: $modified_at, id: $id, source: $source, amount_type: $amount_type, price_currency: $price_currency, tax_behavior: $tax_behavior, is_archived: $is_archived, product_id: $product_id, type: $type, recurring_interval: $recurring_interval, price_amount: $price_amount, legacy: $legacy)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$LegacyRecurringProductPriceFixedImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LegacyRecurringProductPriceFixedImplCopyWith<
          _$LegacyRecurringProductPriceFixedImpl>
      get copyWith => __$$LegacyRecurringProductPriceFixedImplCopyWithImpl<
          _$LegacyRecurringProductPriceFixedImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LegacyRecurringProductPriceFixedImplToJson(
      this,
    );
  }
}

abstract class _LegacyRecurringProductPriceFixed
    implements LegacyRecurringProductPriceFixed {
  const factory _LegacyRecurringProductPriceFixed(
      ...
      required final bool legacy}) = _$LegacyRecurringProductPriceFixedImpl;

  factory _LegacyRecurringProductPriceFixed.fromJson(
          Map<String, dynamic> json) =
      _$LegacyRecurringProductPriceFixedImpl.fromJson;
