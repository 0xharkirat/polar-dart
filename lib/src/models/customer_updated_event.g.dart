...
_$CustomerUpdatedEventImpl _$$CustomerUpdatedEventImplFromJson(
    ...
    _$CustomerUpdatedEventImpl(
      ...
      metadata: CustomerUpdatedMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$CustomerUpdatedEventImplToJson(
        _$CustomerUpdatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
