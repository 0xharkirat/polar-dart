...
_$ProductPriceFreeCreateImpl _$$ProductPriceFreeCreateImplFromJson(
...
Map<String, dynamic> _$$ProductPriceFreeCreateImplToJson(
        _$ProductPriceFreeCreateImpl instance) =>
    <String, dynamic>{
