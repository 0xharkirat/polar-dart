...
_$BalanceRefundReversalEventImpl _$$BalanceRefundReversalEventImplFromJson(
    ...
    _$BalanceRefundReversalEventImpl(
      ...
      metadata: BalanceRefundMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$BalanceRefundReversalEventImplToJson(
        _$BalanceRefundReversalEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
