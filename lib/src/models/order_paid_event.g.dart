...
_$OrderPaidEventImpl _$$OrderPaidEventImplFromJson(Map<String, dynamic> json) =>
    _$OrderPaidEventImpl(
      ...
      metadata:
          OrderPaidMetadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$OrderPaidEventImplToJson(
        _$OrderPaidEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
