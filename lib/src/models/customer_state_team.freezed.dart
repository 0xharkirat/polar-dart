...
CustomerStateTeam _$CustomerStateTeamFromJson(Map<String, dynamic> json) {
  return _CustomerStateTeam.fromJson(json);
}

/// @nodoc
mixin _$CustomerStateTeam {
  ...
  /// Serializes this CustomerStateTeam to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CustomerStateTeam
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CustomerStateTeamCopyWith<CustomerStateTeam> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CustomerStateTeamCopyWith<$Res> {
  factory $CustomerStateTeamCopyWith(
          CustomerStateTeam value, $Res Function(CustomerStateTeam) then) =
      _$CustomerStateTeamCopyWithImpl<$Res, CustomerStateTeam>;
  @useResult
  $Res call(
      {String id,
      String created_at,
...
/// @nodoc
class _$CustomerStateTeamCopyWithImpl<$Res, $Val extends CustomerStateTeam>
    implements $CustomerStateTeamCopyWith<$Res> {
  _$CustomerStateTeamCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CustomerStateTeamImplCopyWith<$Res>
    implements $CustomerStateTeamCopyWith<$Res> {
  factory _$$CustomerStateTeamImplCopyWith(_$CustomerStateTeamImpl value,
          $Res Function(_$CustomerStateTeamImpl) then) =
      __$$CustomerStateTeamImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$CustomerStateTeamImplCopyWithImpl<$Res>
    extends _$CustomerStateTeamCopyWithImpl<$Res, _$CustomerStateTeamImpl>
    implements _$$CustomerStateTeamImplCopyWith<$Res> {
  __$$CustomerStateTeamImplCopyWithImpl(_$CustomerStateTeamImpl _value,
      $Res Function(_$CustomerStateTeamImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CustomerStateTeamImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$CustomerStateTeamImpl implements _CustomerStateTeam {
  const _$CustomerStateTeamImpl(
      {required this.id,
  ...
  factory _$CustomerStateTeamImpl.fromJson(Map<String, dynamic> json) =>
      _$$CustomerStateTeamImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CustomerStateTeam(id: $id, created_at: $created_at, modified_at: $modified_at, metadata: $metadata, external_id: $external_id, email: $email, email_verified: $email_verified, type: $type, name: $name, billing_address: $billing_address, tax_id: $tax_id, locale: $locale, organization_id: $organization_id, deleted_at: $deleted_at, active_subscriptions: $active_subscriptions, granted_benefits: $granted_benefits, active_meters: $active_meters, avatar_url: $avatar_url)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CustomerStateTeamImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CustomerStateTeamImplCopyWith<_$CustomerStateTeamImpl> get copyWith =>
      __$$CustomerStateTeamImplCopyWithImpl<_$CustomerStateTeamImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CustomerStateTeamImplToJson(
      this,
    );
  }
}

abstract class _CustomerStateTeam implements CustomerStateTeam {
  const factory _CustomerStateTeam(
      ...
      required final List<CustomerStateBenefitGrant> granted_benefits,
      required final List<CustomerStateMeter> active_meters,
      required final String avatar_url}) = _$CustomerStateTeamImpl;

  factory _CustomerStateTeam.fromJson(Map<String, dynamic> json) =
      _$CustomerStateTeamImpl.fromJson;
