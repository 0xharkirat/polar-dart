...
_$BenefitGrantMeterCreditWebhookImpl
    _$$BenefitGrantMeterCreditWebhookImplFromJson(Map<String, dynamic> json) =>
        _$BenefitGrantMeterCreditWebhookImpl(
          ...
          member: json['member'],
          benefit: BenefitMeterCredit.fromJson(
...
Map<String, dynamic> _$$BenefitGrantMeterCreditWebhookImplToJson(
        _$BenefitGrantMeterCreditWebhookImpl instance) =>
    <String, dynamic>{
