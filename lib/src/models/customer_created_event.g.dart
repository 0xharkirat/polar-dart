...
_$CustomerCreatedEventImpl _$$CustomerCreatedEventImplFromJson(
    ...
    _$CustomerCreatedEventImpl(
      ...
      metadata: CustomerCreatedMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$CustomerCreatedEventImplToJson(
        _$CustomerCreatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
