...
_$SubscriptionCycledEventImpl _$$SubscriptionCycledEventImplFromJson(
    ...
    _$SubscriptionCycledEventImpl(
      ...
      metadata: SubscriptionCycledMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$SubscriptionCycledEventImplToJson(
        _$SubscriptionCycledEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
