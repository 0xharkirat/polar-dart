...
_$OrderRefundedEventImpl _$$OrderRefundedEventImplFromJson(
    ...
    _$OrderRefundedEventImpl(
      ...
      metadata: OrderRefundedMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$OrderRefundedEventImplToJson(
        _$OrderRefundedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
