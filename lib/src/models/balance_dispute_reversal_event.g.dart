...
_$BalanceDisputeReversalEventImpl _$$BalanceDisputeReversalEventImplFromJson(
    ...
    _$BalanceDisputeReversalEventImpl(
      ...
      metadata: BalanceDisputeMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$BalanceDisputeReversalEventImplToJson(
        _$BalanceDisputeReversalEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
