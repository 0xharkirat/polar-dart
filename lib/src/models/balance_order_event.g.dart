...
_$BalanceOrderEventImpl _$$BalanceOrderEventImplFromJson(
        Map<String, dynamic> json) =>
    _$BalanceOrderEventImpl(
      ...
      metadata: BalanceOrderMetadata.fromJson(
          json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$BalanceOrderEventImplToJson(
        _$BalanceOrderEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
