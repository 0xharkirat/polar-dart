...
_$CustomerBenefitGrantGitHubRepositoryImpl
    _$$CustomerBenefitGrantGitHubRepositoryImplFromJson(
        ...
        _$CustomerBenefitGrantGitHubRepositoryImpl(
          ...
          benefit: BenefitGitHubRepositorySubscriber.fromJson(
              json['benefit'] as Map<String, dynamic>),
          properties: BenefitGrantGitHubRepositoryProperties.fromJson(
              json['properties'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$$CustomerBenefitGrantGitHubRepositoryImplToJson(
        _$CustomerBenefitGrantGitHubRepositoryImpl instance) =>
    <String, dynamic>{
