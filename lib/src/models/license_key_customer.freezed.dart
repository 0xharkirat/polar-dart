...
class _$LicenseKeyCustomerImpl implements _LicenseKeyCustomer {
  ...
  @override
  String toString() {
    return 'LicenseKeyCustomer(created_at: $created_at, modified_at: $modified_at, id: $id, metadata: $metadata, email: $email, email_verified: $email_verified, name: $name, billing_address: $billing_address, tax_id: $tax_id, organization_id: $organization_id, avatar_url: $avatar_url)';
  }
