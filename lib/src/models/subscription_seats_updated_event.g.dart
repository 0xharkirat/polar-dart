...
_$SubscriptionSeatsUpdatedEventImpl
    _$$SubscriptionSeatsUpdatedEventImplFromJson(Map<String, dynamic> json) =>
        _$SubscriptionSeatsUpdatedEventImpl(
          ...
          metadata: SubscriptionSeatsUpdatedMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$$SubscriptionSeatsUpdatedEventImplToJson(
        _$SubscriptionSeatsUpdatedEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
