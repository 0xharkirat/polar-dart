...
_$MeterResetEventImpl _$$MeterResetEventImplFromJson(
        Map<String, dynamic> json) =>
    _$MeterResetEventImpl(
      ...
      metadata:
          MeterResetMetadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$MeterResetEventImplToJson(
        _$MeterResetEventImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
