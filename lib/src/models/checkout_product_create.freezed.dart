...
class _$CheckoutProductCreateImpl implements _CheckoutProductCreate {
  ...
  @override
  String toString() {
    return 'CheckoutProductCreate(trial_interval: $trial_interval, trial_interval_count: $trial_interval_count, metadata: $metadata, custom_field_data: $custom_field_data, discount_id: $discount_id, allow_discount_codes: $allow_discount_codes, require_billing_address: $require_billing_address, amount: $amount, seats: $seats, min_seats: $min_seats, max_seats: $max_seats, allow_trial: $allow_trial, customer_id: $customer_id, is_business_customer: $is_business_customer, external_customer_id: $external_customer_id, customer_name: $customer_name, customer_email: $customer_email, customer_ip_address: $customer_ip_address, customer_billing_name: $customer_billing_name, customer_billing_address: $customer_billing_address, customer_tax_id: $customer_tax_id, customer_metadata: $customer_metadata, subscription_id: $subscription_id, success_url: $success_url, return_url: $return_url, embed_origin: $embed_origin, locale: $locale, currency: $currency, product_id: $product_id)';
  }
