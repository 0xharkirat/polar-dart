...
class Pledge {
  ...
  Pledge({
    ...
    required this.state,
    required this.type,
    required this.refunded_at,
    required this.scheduled_payout_at,
    required this.issue,
    required this.pledger,
    required this.hosted_invoice_url,
    required this.authed_can_admin_sender,
    required this.authed_can_admin_received,
